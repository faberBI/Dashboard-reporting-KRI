...
from functions.interest_rate import (download_ecb_series, download_yahoo_series, plot_predictions_streamlit, simulate_euribor, plot_full_forecast, get_spread_for_date, get_plan_euribor_for_date)
