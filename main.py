...
# -----------------------
    ...
    **Variabili incluse nel modello:**  
    ...
    df_yahoo = download_yahoo_series(yahoo_symbols, start = '2023-01-01')
    df_all = df_ecb.join(df_yahoo, how="outer")
    df_all = df_all.sort_index().ffill()
    df_dropped = df_all.dropna()
# ============================================================
...
if uploaded_file and run_sim:
    ...
    perdita_totale_perc = (perdita_totale_mln/unhedged_total)*100
    st.metric(label="Perdita Totale % su Un-Hedged", value=f"{np.round(perdita_totale_perc, 2)} %")
