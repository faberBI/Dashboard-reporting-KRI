...
from functions.energy_risk import (get_return, apply_cholesky, fit_sarimax_model, forecast_monthly_prices, get_garch, simulate_prices, compute_VaR, plot_pun_forecast_vs_volatility, plot_monthly_VaR)
...
if selected_kri == "⚡ Energy Risk": 
    ...
    if st.button("💹 Esegui simulazione Energy Risk"):
        ...
        PUN_monthly_forecast = forecast_monthly_prices(last_5y, n_years=n_year)
